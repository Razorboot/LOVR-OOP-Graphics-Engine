...
function TSerial.pack(t, drop, indent)
	...
	for k, v in pairs(t) do
		...
		else error("Attempted to TSerial.pack a table with an invalid key: "..tostring(k))-- k = "nil"
		end
		...
		elseif drop then skip = true
		else error("Attempted to TSerial.pack a table with an invalid value: "..tostring(v))-- k = "nil"
		end
