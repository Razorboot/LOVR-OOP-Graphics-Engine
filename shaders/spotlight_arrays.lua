spotlightShader = lovr.graphics.newShader([[
    ...
    // Helper Functions
    float sampleShadowMap(int lightIndex, vec2 coords, float compare)
    {
        return step(compare, getPixel(depthBuffers, coords.xy, lightIndex).r);
    }
